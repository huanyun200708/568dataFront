		...
		wx.request({
			...
			success: function success(res) {
				...
				var summaryInfoList = [
					...
					{
						"code": "出险次数",
						"text": o.summaryData.claimCount
					},
					{
						"code": "理赔总金额(元)",
						"text": o.summaryData.claimMoney
					},
					{
						"code": "维修总金额(元)",
						"text": o.summaryData.repairMoney
					},
					{
						"code": "维修总件数",
						"text": o.summaryData.repairCount
					},
					{
						"code": "换件总金额(元)",
						"text": o.summaryData.renewMoney
					}
				]
				wx.hideLoading(); //////////////////////////////////////////////
				that.setData({
					listData: summaryInfoList,
					carClaimRecords: o.carClaimRecords
				});
			},
			'fail': function(res) {
				wx.hideLoading(); //////////////////////////////////////////////
